...
PHP Riot API 
Uitgeschreven door: Bas Knobbout
Dit script is geschreven uitsluitend voor BEM Media. Dit script zorgt ervoor dat met simpele calls de statistieken van League of Legends ( De PHP Riot Api) kunnen aanroepen.
Hier kunnen nog fouten inzitten en kunnen veranderd worden.
...
class riotapi {
	...
	const API_URL_PLATFORM_3 = "https://euw1.api.riotgames.com/lol/platform/v3/";
	const API_URL_CHAMPION_MASTERY_3 = "https://euw1.api.riotgames.com/lol/champion-mastery/v3/";
	const API_URL_SPECTATOR_3 = 'https://euw1.api.riotgames.com/lol/spectator/v3/';
	const API_URL_STATIC_3 = 'https://euw1.api.riotgames.com/lol/static-data/v3/';
	const API_URL_MATCH_3 = 'https://euw1.api.riotgames.com/lol/match/v3/';
	const API_URL_LEAGUE_3 = 'https://euw1.api.riotgames.com/lol/league/v3/';
	const API_URL_SUMMONER_3 = 'https://euw1.api.riotgames.com/lol/summoner/v3/';


	const API_KEY = 'RGAPI-4106a99d-ebeb-4f0c-beed-4433e14fceb9';
